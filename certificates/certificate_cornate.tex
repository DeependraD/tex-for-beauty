% downloaded from:
% https://tex.stackexchange.com/a/73680/133229
...
\TileWallPaper{4cm}{2cm}{certificate_cornate_ornate.png}
...
\centering
\includegraphics[height=1.1cm]{certificate_cornate_coa.png}
\end{minipage}
\vspace{-8mm}
